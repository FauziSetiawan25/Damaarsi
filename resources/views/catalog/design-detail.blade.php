...
<main class="container my-5">
    <div class="row align-items-start">
            ...
            <div id="designCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                ...
                <div class="carousel-indicators">
                    @foreach($design->images as $index => $image)
                        <button type="button" data-bs-target="#designCarousel" data-bs-slide-to="{{ $index }}" class="{{ $index === 0 ? 'active' : '' }}" aria-label="Slide {{ $index + 1 }}"></button>
                    @endforeach
                </div>
                ...
                <div class="carousel-inner">
                    @foreach($design->images as $index => $image)
                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                            <img src="{{ $image->url }}" class="d-block w-100 rounded" alt="design Image {{ $index + 1 }}">
                        </div>
                    @endforeach
                </div>
            </div>
        ...
        <div class="col-md-5 mt-3">
            ...
            <a href="https://wa.me/your_number?text=Consultation%20for%20{{ urlencode($design->title) }}" class="btn btn-success mt-3 mb-3 w-100">
